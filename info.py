...
BOT_TOKEN = environ.get('BOT_TOKEN', "7388981098:AAHowLpEFaNLftRtA5YaPrA3UsW543eDw8Q")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002447009284'))
...
# Shortlink Info
SHORTLINK_MODE = bool((environ.get('SHORTLINK_MODE', "True")), True)
