...
class script(object):
    START_TXT = """<b><blockquote>Hᴇʟʟᴏ {}, 
    
𝐼'𝑚 𝒕𝒉𝒆 𝒎𝒐𝒔𝒕 𝒂𝒅𝒗𝒂𝒏𝒄𝒆𝒅 𝒑𝒓𝒐𝒗𝒊𝒅𝒆𝒓 𝒊𝒏 𝒘𝒉𝒐𝒍𝒆 𝒕𝒈. 𝒋𝒖𝒔𝒕 𝒂𝒔𝒌 𝒎𝒆 𝒕𝒉𝒆 𝒏𝒂𝒎𝒆 𝒂𝒏𝒅 𝒊 𝒘𝒊𝒍𝒍 𝒔𝒆𝒏𝒅 𝒚𝒐𝒖𝒓 𝒇𝒊𝒍𝒆 𝒊𝒏 𝒑𝒆𝒓𝒇𝒆𝒄𝒕 𝒓𝒆𝒔𝒐𝒍𝒖𝒕𝒊𝒐𝒏 𝒌𝒊𝒏𝒅𝒍𝒚 𝒔𝒖𝒑𝒑𝒐𝒓𝒕 𝒂𝒔 𝒎𝒖𝒄𝒉 𝒚𝒐𝒖 𝒄𝒂𝒏 #Filmy_tube """
